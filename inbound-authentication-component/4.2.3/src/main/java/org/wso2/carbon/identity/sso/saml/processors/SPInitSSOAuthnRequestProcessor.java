...
import org.wso2.carbon.identity.sso.saml.builders.ArtifactMessageBuilder;
...
public class SPInitSSOAuthnRequestProcessor {
    ...
    public SAMLSSORespDTO process(SAMLSSOAuthnReqDTO authnReqDTO, String sessionId,
        ...
        try {
            ...
            if (isAuthenticated) {
                ...
                samlResp = SAMLSSOUtil.marshall(response);
                ...
                if(authnReqDTO.isArtifactBinding()) {
                    // TODO Set Protocol Binding Configuration : serviceProviderConfigs.getProtocolBinding()
                    ArtifactMessageBuilder artifactMessageBuilder = new ArtifactMessageBuilder();
                    samlResp = artifactMessageBuilder.buildArtifact(samlssoRespDTO);
                    samlssoRespDTO.setRespString(samlResp);
                }
            }
    ...
    private void populateServiceProviderConfigs(SAMLSSOServiceProviderDO ssoIdpConfigs,
        ...
        authnReqDTO.setArtifactBinding(true);       // TODO get this from the  SAMLSSOServiceProviderDO
    }
